...
public partial class InitialMvp : Migration
{
    ...
    {
        migrationBuilder.DropTable(name: "animal_case_timeline_events");
        migrationBuilder.DropTable(name: "donation_timeline_events");
        migrationBuilder.DropTable(name: "donor_consent_events");
        migrationBuilder.DropTable(name: "recurring_donations");
        migrationBuilder.DropTable(name: "tax_receipts");
        migrationBuilder.DropTable(name: "animal_cases");
